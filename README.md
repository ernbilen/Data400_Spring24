...
## Introduction ##
This study investigates the gap between students’ and schools’ definitions of success and its impact on U.S. high school dropout rates. High school dropout rates are influenced by a variety of factors, such as students' perceptions of schooling and the school environment. Students who feel unsafe at school or experience peer rejection and isolation are at higher risk of dropping out. (Cueller et al., 2017). Chronic absenteeism, which is often linked to safety concerns, is also a strong predictor of school dropout (School Dropouts — The Civil Rights Project at UCLA, n.d.). ​Additionally, there can be a disconnect between how schools define success (e.g. test scores, graduation rates) versus how students define success (e.g. feeling supported, having a sense of belonging) (DeLuca & Rosenbaum, 2000). This mismatch can contribute to students becoming disengaged and ultimately dropping out.​ This project aims to provide a statistical framework to aid high school counselors & administrators in (1) identifying dropout risks and (2) supporting students in achieving their life goals through discussing areas of schooling & school environment​.
